...
$token="8386329255:AAHFf5u8_omLiP_IDfig3Kc_Guy-_L2p7t8";
...
function bot($method,$datas=[]){
	$url = "https://api.telegram.org/bot8386329255:AAHFf5u8_omLiP_IDfig3Kc_Guy-_L2p7t8/".$method;
	$ch = curl_init();
...
<i>Marhamat, kerakli kodni yuboring:</i>",
	...
	'inline_keyboard'=>[
	[['text'=>"🔎 Kodlarni qidirish",'url'=>"https://t.me/$kodli_baza"]]
]
])
]);
